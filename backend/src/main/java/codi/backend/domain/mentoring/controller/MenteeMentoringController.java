...
@Tag(name = "Mentee's Mentoring", description = "멘티 기준 멘토링 API")
@RestController
...
public class MenteeMentoringController {
    ...
    @Operation(summary = "Mentoring 후 Mentor 평가", description = "멘티가 멘토링과 멘토 정보, 별점을 입력해서 평가할 수 있다. 다른 request 필드가 많아서 RequestBody에 입력받는다.")
    @PostMapping("/rate")
