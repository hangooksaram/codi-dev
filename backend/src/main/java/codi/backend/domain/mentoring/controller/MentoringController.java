...
public class MentoringController {
    ...
    public ResponseEntity applyMentoring(@PathVariable("profile-id") Long profileId, @PathVariable("mentor-id") Long mentorId, @Valid @RequestBody MentoringDto.MentoringPost mentoringPostDto) {
