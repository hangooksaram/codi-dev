...
public class QSchedule extends EntityPathBase<Schedule> {
    ...
    private static final long serialVersionUID = 1195237022L;
    ...
    public final codi.backend.domain.mentoring.entity.QMentoring mentoring;
    ...
    public QSchedule(Class<? extends Schedule> type, PathMetadata metadata, PathInits inits) {
        ...
        this.mentoring = inits.isInitialized("mentoring") ? new codi.backend.domain.mentoring.entity.QMentoring(forProperty("mentoring"), inits.get("mentoring")) : null;
    }
